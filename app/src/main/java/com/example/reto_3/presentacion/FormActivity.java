    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                apiOracle.insertProducto(campo1Insert, campo2Insert, campo3Insert, imgSelected);
                limpiarCampos();
        ...
        btnConsultar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                apiOracle.getProductoById(editId.getText().toString(), imgSelected, campo1, campo2, campo3);
                //View view = findViewById(R.id.linearLayoutForm);
